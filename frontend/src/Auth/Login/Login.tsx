...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDF8EF] font-sans flex flex-col justify-between relative overflow-hidden text-[#1a1a1a]">
      ...
      <div className="absolute left-10 bottom-32 hidden lg:flex items-end z-0">
        <div
      ...
      <div className="absolute right-10 bottom-32 hidden lg:flex items-end z-0">
        <div className="w-24 h-32 bg-white border border-gray-200 shadow-sm mr-4 relative">
          {/* Simulated person sitting */}
      ...
      <div className="absolute bottom-32 w-full h-px bg-gray-300 z-0 hidden lg:block"></div>
        ...
        <div className="bg-white rounded-4xl shadow-[0_20px_50px_rgba(0,0,0,0.06)] p-10 sm:p-12 w-full max-w-120">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="relative">
              ...
              {/* <button
                type="button"
                className="absolute right-5 top-1/2 -translate-y-1/2 text-sm font-semibold text-gray-800"
              >
                Hide
              </button> */}
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#FBCF9E] hover:bg-[#f2b978] text-black font-bold rounded-xl py-3.5 mt-2 transition"
            >
              Sign in
            </button>
          </form>
